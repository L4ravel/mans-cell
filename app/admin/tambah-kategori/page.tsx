// Halaman admin kategori barang untuk CRUD kategori barang.
...
export default function KategoriBarangPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteDoc(doc(db, "kategori_barang", deleteTarget.id));
            ...
            <div className="flex min-w-0 items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-xs font-semibold leading-relaxed text-sky-50/85 sm:text-sm">
                  Kelola master kategori produk dan sinkronisasi nama kategori.
                </p>
              </div>
            </div>
  ...
  if (filtered.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center gap-3 py-12">
        ...
        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400">
          Kategori barang belum tersedia
        </p>
        <motion.button
          whileTap={{ scale: 0.97 }}
          transition={{ duration: 0.12, ease: "easeOut" }}
          ...
          >
            ...
            <div className="space-y-3 p-5">
              <p className="text-[11px] font-semibold text-slate-600">
                Anda yakin mau menghapus kategori ini?
              </p>
