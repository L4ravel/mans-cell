...
export default function TambahKaryawanPage() {
  ...
  const fetchToko = async () => {
    try {
      ...
      const list: Toko[] = snap.docs.map((d) => {
  ...
  const filtered = useMemo(() => {
    return data.filter((d) => {
      ...
      const matchJabatan = !filterJabatan || d.jabatan === filterJabatan

      return matchSearch && matchToko && matchJabatan
    })
  ...
  const openEdit = (d: Karyawan) => {
    setForm({
      ...
      tokoId: d.tokoId,
      jabatan: d.jabatan,
      tahunMasuk: d.tahunMasuk ? String(d.tahunMasuk) : "",
      aktif: d.aktif,
    })
    setEditId(d.id)
    setError(null)
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-xs">
              <thead className="bg-white/80 border-b border-slate-200">
                <tr>
                  {["No", "Nama", "Toko", "Jabatan", "Tahun Masuk", "Email", "No HP", "Status", "Aksi"].map(
                    (h) => (
                      <th
                        key={h}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/70 font-semibold mt-0.5">
                      {isEdit ? "Perbarui informasi karyawan" : "Isi field wajib (*)"}
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <FormInput
                      ...
                      type="tel"
                      value={form.noHp}
                      onChange={(e: any) => setField("noHp")(e.target.value)}
                    ...
                    <FormInput
                      ...
                      onChange={(e: any) => setField("tahunMasuk")(e.target.value)}
                      placeholder="2024"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <FormSelect
                      ...
                      icon={Briefcase}
                      value={form.jabatan}
                      onChange={(e: any) => setField("jabatan")(e.target.value)}
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <FormSelect
                      ...
                      onChange={(e: any) => setField("aktif")(e.target.value === "aktif")}
                    >
